...
import Link from "next/link"; // Import for icons
      ...
      <div className="bg-white py-3 px-4 sm:px-6 lg:px-8 shadow-md">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            <a href="#hero" className="text-gray-700 hover:underline">
              Home
            </a>
            <a href="#manage" className="text-gray-700 hover:underline">
              Manage Booking
            </a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white shadow-lg py-4">
            <div className="flex flex-col space-y-4">
              <a href="#hero" className="text-gray-700 px-4">
                Home
              </a>
              <a href="#manage" className="text-gray-700 px-4">
                Manage Booking
              </a>
